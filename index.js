// const jsBtnEl = document.querySelector("#button-js");
// const reactBtnEl = document.querySelector("#button-react");
// const cssBtnEl = document.querySelector("#button-css");
// const htmlBtnEl = document.querySelector("#button-html");
