...
// function getQuestions(difficulty, subject){
    ...
    .then(allQuestions =>{
        ...
        questions = getRandomElements(filteredQuestions, 10);
...
form.addEventListener("submit", function(event) {
    ...
    window.location.replace("result.html");//open result page in same tab(since we are using replace, user can't go back to the previous page)
});
